...
public class ProductsController : Controller
{
    ...
    public async Task<IActionResult> Edit(int? id)
    {
        ...
        if (product == null) RedirectToAction("PageNotFound", "Error");
        ...
        ViewData["CategoryId"] =
            new SelectList(_productService.GetAllCategoriesAsync().Result, "Id", "Name", product.CategoryId);
    ...
    public async Task<IActionResult> Delete(int? id)
    {
        ...
        var product = await _productService.GetByIdWithCategoryAsync((int)id);
        if (product == null) return RedirectToAction("PageNotFound", "Error");
